...
function BuySellCard({buyPrice,sellPrice,desc}){
        ...
        <div style={{width:'30em', height:'25em',backgroundColor:'white'}}>
            ...
            {option === 0 && (
                <div style={{height:'85%',width:'100%',display:'flex',alignItems:'center',justifyContent:'space-evenly',flexDirection:'column'}}>
                    ...
                    <div style={{width:'100%'}}>
                        <button style={{backgroundColor: '#2196F3', border:'0px', color: 'white', width:'50%', height:'2.5em',borderRadius:'1em'}}>Buy</button>
                    </div>
                </div>
            )}
            {option === 1 && (
                <div style={{height:'85%',width:'100%',display:'flex',alignItems:'center',justifyContent:'space-evenly',flexDirection:'column'}}>
                    ...
                    <div style={{display:'flex',alignItems:'start',justifyContent:'start',flexDirection:'column', width:'47%'}}>
                        ...
                        <div style={{width:'100%'}}>
                            <input style={{border:'1px solid grey', width:'100%'}} />
                        </div>                 
                    </div>
                    <div style={{width:'100%'}}>
                        <button style={{backgroundColor: '#2196F3', border:'0px', color: 'white', width:'50%', height:'2.5em',borderRadius:'1em'}}>Sell</button>
                    </div>
                </div>
            )}
        </div>
